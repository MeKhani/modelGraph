...
class EntInit(nn.Module):
    def __init__(self, args):
        ...
        self.rel_head_emb = nn.Parameter(torch.Tensor(args.num_rel, args.dimension_entity))
        self.rel_tail_emb = nn.Parameter(torch.Tensor(args.num_rel, args.dimension_entity))
    ...
    def forward(self, g_bidir):
        ...
        g_bidir.edata['ent_e'] = torch.zeros(num_edge, self.args.dimension_entity).to(self.args.gpu)
